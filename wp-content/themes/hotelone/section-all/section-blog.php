				...
				<div class="news">
					...
					<div class="news_body">
						...
						<div class="news_details">
							<i class="fa fa-user"></i> <span><?php esc_html_e('Posted by:','hotelone'); ?> </span> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php echo esc_html(get_the_author_link());?></a>
